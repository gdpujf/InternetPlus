			...
			<view class="post_right">
				...
				<view class="toolbar">
					...
					<view class="like" @tap="like(index)">
						<image :src="post.islike===0?'../../static/live/islike.png':'../../static/live/like.png'"></image>
					</view>
					<view class="comment" @tap="comment(index)">
						<image src="../../static/live/comment.png"></image>
					</view>
				</view>
				<!-- 赞／评论区 -->
				<view class="post-footer">
					<view class="footer_content">
						<image class="liked" src="../../static/live/liked.png"></image>
